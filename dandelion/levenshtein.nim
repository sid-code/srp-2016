## This module exports a function that computes the levenshtein distance
## between two strings.
##
## It is shamelessly stolen from: https://rosettacode.org/wiki/Levenshtein_distance#Nim
